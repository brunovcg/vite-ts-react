...
function TabsItem<TabId extends string | number>({ children, id, css, className }: TabsItemProps<TabId>) {
...
function TabsNav({ css }: PropsWithCss) {
  ...
  return (
    <nav css={[orientation === "vertical" ? "border-right" : "border-bottom", orientation === "horizontal" && "width-fit", "padding-inline-sm", css]} data-component='TabsNav' data-css='Tabs'>
