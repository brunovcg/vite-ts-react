...
import { CreateComponent, type AttributesOptionalChildren } from "@/components/create-component/CreateComponent.component";
    ...
    try {
      ...
      if (params) {
        ...
        items.forEach((item) => {
          ...
          dialogController.open(id as DialogId, { props } as never);
        });
      }
    } catch {
      return;
