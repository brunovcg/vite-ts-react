...
export function DesignSystem() {
  ...
  return (
    <div className='design-system-container' css={["width-full", "height-viewport", "overflow-hidden", "background-light", "display-flex"]}>
      {/* Sidebar Navigation */}
      <aside css={["width-quarter", "height-full", "overflow-hidden", "background-white", "border-right", "padding-lg"]}>
        <div css={["margin-bottom-xl"]}>
          <h1 css={["font-size-xl", "text-bold", "color-primary", "margin-bottom-md"]}>Design System</h1>
          <button css={["cursor-pointer", "padding-sm", "width-full", "background-error-light", "color-error", "border-none", "border-radius-md", "opacity-hover"]} onClick={() => navigate("/")}>
            Exit Design System
          </button>
        </div>
...
function TypeSpecimen({ className, label, css }: { className?: string; label: string; css: Css }) {
  return (
    <div css={["display-flex", "align-center", "gap-md", "padding-bottom-sm", css]}>
