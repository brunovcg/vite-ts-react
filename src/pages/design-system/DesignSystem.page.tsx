    ...
    <div className='design-system-container width-full height-viewport overflow-hidden background-light display-flex'>
      ...
      <aside className='width-quarter height-full overflow-hidden background-white border-right padding-lg shadow-sm z-index-drawer'>
        <div className='margin-bottom-xl'>
          <h1 className='typography size-xl bold color-primary margin-bottom-md'>Design System</h1>
          <button
            className='cursor-pointer padding-sm width-full background-error-light color-error border-none border-radius-md hover-opacity'
            onClick={() => navigate("/")}
          >
            Exit Design System
          </button>
        ...
        <nav className='display-flex flex-column gap-sm'>
          {SECTIONS.map((section) => (
            <a
              key={section.id}
              href={`#${section.id}`}
              className='typography size-md color-typeface-medium hover-opacity padding-sm border-radius-sm'
      ...
      <main className='flex-1 height-full overflow-y-auto padding-2xl scroll-smooth'>
        <Section id='animations' title='Animations' description='Keyframe animations.'>
          <div className='display-flex gap-xl'>
            <div className='display-flex flex-column align-center gap-sm'>
              ...
              <code className='typography size-sm'>.animate-rotate</code>
            </div>
            <div className='display-flex flex-column align-center gap-sm'>
              <div className='padding-xl background-success border-radius-md animate-blink'></div>
              <code className='typography size-sm'>.animate-blink</code>
            </div>
          </div>
        </Section>
        ...
        <Section
          id='borders'
          title='Borders'
          description='Border styles, colors, and specific side borders.'
        >
          <div className='display-flex gap-md flex-wrap'>
            ...
            <div className='padding-lg border border-radius-md background-white'>
              .border-radius-md
            </div>
            <div
          ...
          <div className='margin-top-lg'>
            <h3 className='typography bold margin-bottom-sm'>Border Radius</h3>
        ...
        <Section
          ...
          description='Styled form field containers.'
        >
        ...
        <Section id='cursors' title='Cursors & Interaction' description='Cursor styles.'>
          <div className='display-flex flex-wrap gap-md'>
            {["pointer", "not-allowed", "wait", "text", "move", "help", "grab", "grabbing"].map(
              (c) => (
                <div
                  key={c}
                  className={`cursor-${c} padding-md border background-white border-radius-sm`}
                >
                  .cursor-{c}
                </div>
              ),
        ...
        <Section id='flexbox' title='Flex Box' description='Utilities for Flexbox layout control.'>
          ...
          <div className='margin-top-lg'>
            <h3 className='typography bold margin-bottom-sm'>Gap Sizes</h3>
            <div className='display-flex flex-wrap gap-md'>
          ...
          <div className='margin-top-lg'>
            <h3 className='typography bold margin-bottom-sm'>Flex Grow & Shrink</h3>
        ...
        <Section id='icons' title='Icons' description='Available SVG icons. Click to copy name.'>
          <div className='display-flex flex-wrap gap-lg'>
            {Object.keys(icons).map((iconName) => (
              ...
              >
                <div
                  className='padding-md border border-radius-md background-white display-flex flex-center shadow-sm'
                  style={{ width: "48px", height: "48px" }}
                >
                  <Icon icon={iconName as keyof typeof icons} size='lg' />
                </div>
                <span className='typography size-xs color-typeface-light ellipsis width-full align-center display-inline-block'>
                  {iconName}
                </span>
              </div>
            ))}
        ...
        <Section
          ...
          description='Positioning and display utilities.'
        >
          <div className='display-flex flex-wrap gap-lg'>
            <div className='width-half'>
              <h3 className='typography bold margin-bottom-sm'>Position</h3>
            ...
            <div className='width-half'>
              <h3 className='typography bold margin-bottom-sm'>Display</h3>
        ...
        <Section
          id='spacing'
          title='Spacing'
          description='Padding and Margin utilities. (xs, sm, md, lg, xl, 2xl, 3xl)'
        >
          <div className='margin-bottom-lg'>
            <h3 className='typography bold margin-bottom-sm'>Size Map</h3>
            <div className='display-flex flex-wrap gap-md typography size-sm font-mono'>
          ...
          <div className='display-flex flex-wrap gap-md'>
            <div className='background-white padding-md border border-radius-md'>
              <span className='typography bold'>Padding Examples:</span>
            ...
            <div className='background-white padding-md border border-radius-md'>
              <span className='typography bold'>Margin Examples:</span>
        ...
        <Section
          ...
          description='Classes to truncate text to specific number of lines.'
        >
          <div className='display-flex flex-column gap-md width-half'>
            {[1, 2, 3].map((lines) => (
              <div key={lines}>
                <div
                  className={`text-max-lines-${lines} background-white padding-sm border border-radius-sm`}
                  style={{ width: "100%" }}
                >
                  This is a long text that should be truncated after {lines} line(s). The quick
                  brown fox jumps over the lazy dog repeatedly to ensure the text is long enough to
                  demonstrate the truncation effect propertly. The quick brown fox jumps over the
                  lazy dog.
                </div>
                <code className='typography size-xs color-typeface-light margin-top-xs display-block'>
                  .text-max-lines-{lines}
                </code>
              </div>
            ))}
          </div>
        ...
        <Section
          id='typography'
          title='Typography'
          description='Font styles, weights, and alignment utilities.'
        >
          <div className='display-flex flex-column gap-md'>
            <TypeSpecimen className='typography preset-title' label='.typography.preset-title' />
            <TypeSpecimen className='typography preset-body' label='.typography.preset-body' />
            <div className='separator border-bottom margin-block-lg'></div>
            <TypeSpecimen className='typography size-3xl' label='.typography.size-3xl' />
            <TypeSpecimen className='typography size-2xl' label='.typography.size-2xl' />
            <TypeSpecimen className='typography size-xl' label='.typography.size-xl' />
            <TypeSpecimen className='typography size-lg' label='.typography.size-lg' />
            <TypeSpecimen className='typography size-md' label='.typography.size-md' />
            <TypeSpecimen className='typography size-sm' label='.typography.size-sm' />
            <TypeSpecimen className='typography size-xs' label='.typography.size-xs' />
            <div className='separator border-bottom margin-block-lg'></div>
            <TypeSpecimen className='typography bold' label='.typography.bold' />
            <TypeSpecimen className='typography italic' label='.typography.italic' />
            <TypeSpecimen className='typography underline' label='.typography.underline' />
          </div>
        </Section>
        ...
        <Section
          ...
          description='Core color palette used throughout the application.'
        >
          <ColorGrid />
        </Section>
      </main>
...
function Section({
  ...
  return (
    <div
      id={id}
      className='section margin-bottom-3xl background-white padding-xl border-radius-lg border shadow-sm'
    >
      <h2 className='typography size-xl bold margin-bottom-sm color-primary'>{title}</h2>
      <p className='typography size-md color-typeface-medium margin-bottom-lg'>{description}</p>
      {children}
    </div>
  );
}
    ...
    <div className='display-flex flex-wrap gap-lg'>
      {colors.map((c) => (
        <div key={c.name} className='display-flex flex-column align-center gap-xs'>
          <div
            className='border border-radius-circle shadow-sm'
            style={{ width: "64px", height: "64px", backgroundColor: c.var }}
          />
          <span className='typography size-xs bold'>{c.name}</span>
          <span className='typography size-xs color-typeface-light'>{c.hex}</span>
        </div>
      ))}
    </div>
  );
...
function TypeSpecimen({ className, label }: { className: string; label: string }) {
  return (
    <div className='display-flex align-center gap-md padding-bottom-sm border-bottom-dashed'>
      <span className='typography size-sm color-typeface-light width-third font-mono'>{label}</span>
...
function ClassDoc({ className, description }: { className: string; description: string }) {
  return (
    <div className='display-flex align-center gap-md padding-sm background-light border-radius-sm'>
      <code className='typography bold color-primary' style={{ minWidth: "150px" }}>
        {className}
      </code>
      <span className='typography size-md color-typeface-medium flex-1'>{description}</span>
    </div>
  );
}
...
function SizeBar({ className, label }: { className: string; label: string }) {
  return (
    <div className='width-full background-light border-radius-sm overflow-hidden margin-bottom-xs'>
      <div
        className={`${className} background-primary padding-xs color-white typography size-xs align-center white-space-nowrap`}
      >
        {label}
      </div>
    </div>
...
function ColorSwatch({ className, label }: { className: string; label: string }) {
  return (
    <div
      className={`${className} padding-lg border-radius-md display-flex center align-center border shadow-sm`}
    >
      {label}
    </div>
  );
