...
export const CSS_REGISTER = {
  animations: ["animate-backdrop-fade-in", "animate-blink", "animate-dialog-slide-up", "animate-fade-in", "animate-indeterminate", "animate-rotate", "animate-rotate-slow", "animate-slide-in"],
  background: [
